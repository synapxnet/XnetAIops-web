      ...
      <Card title="部署 MySQL 实例">
        ...
        <div v-show="currentStep === 1">
          <Form layout="vertical" :model="formState" style="max-width: 600px">
            <Row :gutter="16">
              ...
              <Col :span="12">
                <FormItem label="MySQL 端口">
                  <InputNumber
                    v-model:value="formState.mysqlPort"
                    :min="1"
                    :max="65535"
                    style="width: 100%"
                  />
            ...
            <FormItem label="Root 密码" required>
              <Input.Password
                v-model:value="formState.rootPassword"
                placeholder="设置root密码"
              />
            </FormItem>
            <FormItem label="数据目录">
            ...
            <Row :gutter="16">
              ...
              <Col :span="8">
                <FormItem label="InnoDB缓冲池(MB)">
                  <InputNumber
                    v-model:value="formState.innodbBufferPoolSize"
                    :min="128"
                    :step="256"
                    style="width: 100%"
                  />
              ...
              <Col :span="8">
                <FormItem label="最大连接数">
                  <InputNumber
                    v-model:value="formState.maxConnections"
                    :min="10"
                    :step="100"
                    style="width: 100%"
                  />
            ...
            <template
              v-if="formState.role === 'master' || formState.role === 'slave'"
            >
              <Row :gutter="16">
                <Col :span="12">
        ...
        <div v-show="currentStep === 2">
          ...
          <Row :gutter="16" class="mb-4">
            ...
            >
            <Col :span="8"
              ><strong>MySQL版本:</strong> {{ formState.mysqlVersion }}</Col
            >
          </Row>
          <Row :gutter="16" class="mb-4">
            <Col :span="8"
              ><strong>端口:</strong> {{ formState.mysqlPort }}</Col
            >
            <Col :span="8"><strong>角色:</strong> {{ formState.role }}</Col>
            <Col :span="8"
              ><strong>缓冲池:</strong>
              {{ formState.innodbBufferPoolSize }}MB</Col
            >
          </Row>
