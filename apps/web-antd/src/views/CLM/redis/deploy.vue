      ...
      <Card title="部署 Redis 实例">
            ...
            <Row :gutter="16">
              ...
              <Col :span="8">
                <FormItem label="SSH端口">
                  <InputNumber
                    v-model:value="formState.sshPort"
                    :min="1"
                    :max="65535"
                    style="width: 100%"
                  />
            ...
            <Row :gutter="16">
              ...
              <Col :span="12">
                <FormItem label="Redis 端口">
                  <InputNumber
                    v-model:value="formState.redisPort"
                    :min="1"
                    :max="65535"
                    style="width: 100%"
                  />
            ...
            <Row :gutter="16">
              <Col :span="8">
                <FormItem label="最大内存(MB)">
                  <InputNumber
                    v-model:value="formState.maxMemory"
                    :min="64"
                    :step="256"
                    style="width: 100%"
                  />
              ...
              <Col :span="8">
                <FormItem label="淘汰策略">
                  <Select v-model:value="formState.maxMemoryPolicy">
                    ...
                    <Select.Option value="allkeys-lru"
                      >allkeys-lru</Select.Option
                    >
                    <Select.Option value="volatile-lru"
                      >volatile-lru</Select.Option
                    >
                    <Select.Option value="allkeys-random"
                      >allkeys-random</Select.Option
                    >
                    <Select.Option value="volatile-ttl"
                      >volatile-ttl</Select.Option
                    >
                  </Select>
                </FormItem>
              </Col>
                ...
                <FormItem label="部署模式">
                  <Select v-model:value="formState.deployMode">
                    <Select.Option value="standalone"
                      >独立 (Standalone)</Select.Option
                    >
                    <Select.Option value="sentinel"
                      >哨兵 (Sentinel)</Select.Option
                    >
                    <Select.Option value="cluster"
                      >集群 (Cluster)</Select.Option
                    >
                  </Select>
                </FormItem>
              </Col>
              <Col :span="12">
                <FormItem label="角色">
                  <Select v-model:value="formState.role">
                    ...
                    <Select.Option
                      v-if="formState.deployMode === 'sentinel'"
                      value="sentinel"
                      >Sentinel</Select.Option
                    >
                  </Select>
                </FormItem>
              </Col>
              ...
              <Row :gutter="16">
                ...
                <Col :span="6">
                  <FormItem label="主节点端口">
                    <InputNumber
                      v-model:value="formState.masterPort"
                      style="width: 100%"
                    />
                  </FormItem>
                </Col>
              ...
              <Row :gutter="16">
                ...
                <Col :span="12">
                  <FormItem label="Quorum">
                    <InputNumber
                      v-model:value="formState.sentinelQuorum"
                      :min="1"
                      style="width: 100%"
                    />
                  </FormItem>
        ...
        <div v-show="currentStep === 2">
          <Alert
            type="info"
            message="部署预览"
            description="请确认以下配置无误后点击「开始部署」"
            show-icon
            class="mb-4"
          />
          <Row :gutter="16" class="mb-4">
            <Col :span="8"
              ><strong>实例名称:</strong> {{ formState.instanceName }}</Col
            >
            <Col :span="8"
              ><strong>主机:</strong> {{ formState.host }}:{{
                formState.sshPort
              }}</Col
            >
            <Col :span="8"
              ><strong>Redis版本:</strong> {{ formState.redisVersion }}</Col
            >
          </Row>
          <Row :gutter="16" class="mb-4">
            <Col :span="6"
              ><strong>端口:</strong> {{ formState.redisPort }}</Col
            >
            <Col :span="6"
              ><strong>模式:</strong> {{ formState.deployMode }}</Col
            >
            <Col :span="6"><strong>角色:</strong> {{ formState.role }}</Col>
            <Col :span="6"
              ><strong>内存:</strong> {{ formState.maxMemory }}MB</Col
            >
          </Row>
