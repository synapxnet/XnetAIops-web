...
| Field | Value |
| --- | --- |
| Repository | [`synapxnet/XnetAIops-web`](https://github.com/synapxnet/XnetAIops-web) |
| Product version | `1.0.0` |
| Suite tag | `goai-v1.1.0` |
| Candidate base commit | `39962456a2edddaf95b2f64f96d8e6c8127cdac9` |
| Component role | XnetAIOps web console derived from the Vben ecosystem |
| Repository license | `MIT` |
| SBOM components | 2210 dependency records |
